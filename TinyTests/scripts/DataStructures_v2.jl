...
function JacobianFSG(DAT, device, ncx, ncy)
        Jacobian = (;
        ξ = (∂x = (x=device_array(DAT, device, ncx+1, ncy+0), y=device_array(DAT, device, ncx+0, ncy+1), v=device_array(DAT, device, ncx+1, ncy+1), c=device_array(DAT, device, ncx+2, ncy+2)),
             ∂y = (x=device_array(DAT, device, ncx+1, ncy+0), y=device_array(DAT, device, ncx+0, ncy+1), v=device_array(DAT, device, ncx+1, ncy+1), c=device_array(DAT, device, ncx+2, ncy+2)) ),
        η = (∂x = (x=device_array(DAT, device, ncx+1, ncy+0), y=device_array(DAT, device, ncx+0, ncy+1), v=device_array(DAT, device, ncx+1, ncy+1), c=device_array(DAT, device, ncx+2, ncy+2)),
             ∂y = (x=device_array(DAT, device, ncx+1, ncy+0), y=device_array(DAT, device, ncx+0, ncy+1), v=device_array(DAT, device, ncx+1, ncy+1), c=device_array(DAT, device, ncx+2, ncy+2)) ),
        )
